...
```{r fig45, fig.cap="Spatial distribution pattern of in situ chlorophyll-a at the Zanzibar channel site (a) Rainy season (b) Dry season", fig.align="center", fig.height=3.5}
...
Figure \@ref(fig:fig47) show climatological monthly mean variation of Chl-*a* and SST for the study area (Figure \@ref(fig:fig31)a & \@ref(fig:fig31)b) . SST and chl-a revealed a complete inverse relation. There was a decrease in Chl-a concentration from January to March when the SST increased, and the Chl-a concentration increased from April and May and at this time the SST decreased. There were a slightly decrease in Chl-a on June whilst the SST marginally increased. When the Chl-a concentration started to increase again from June to August, there was a decrease in SST, and the Chl-a decrease from September to December and during this period SST was very high.

The mean Chl-a concentration displayed a bimodal distribution with a high peak in April-May and in July-August (Figure \@ref(fig:fig47). Kruskal-Wallis ANOVA (KWANOVA) test showed a significant difference in Chl-a (H = 66.23, 11 d.f, p < 0.05) and SST (H = 244.27, 11 d.f, p < 0.05) variation among months.


```{r fig47, fig.cap="Monthly mean climatology of a) chlorophyll-a and b) sea surface temperature for Pemba and Zanzibar Channel", fig.align="center", fig.height=4, fig.width=5}
...
The correlation between satellite SST and satellite Chl-a was then calculated using Pearson’s correlation analysis. There was a strong inverse correlation between satellite SST and Chl-a (Figure \@ref(fig:fig48)), and this was found to be statistically significant (r = -0.90, p < 0.05). 
...
The variation of Chl-a concentration in the study region was observed during the dry and the rainy seasons. For the purpose of this study, March through June was considered as the rainy season while January, February, July, August, September, October, November and December was considered the dry season.  Considering the in situ seasonal Chl-a variations between seasons at Zanzibar and Pemba channels,  the concentration was relatively higher at both study sites during the rainy season, with  an average Chl-a concentration of above 0.31 mg/m3 compared to dry season, in which the Chl-a concentration was observed to be below 0.06 mg/m3 (Figure \@ref(fig:fig49). The results revealed that the variation of the in situ Chl-a concentration between seasons was statistically significant (U= 19, 1d.f., p = 9.15 × 10-21).
...
Considering the Chl-a concentration between sites and among seasons, Zanzibar channel had slightly higher concentration compared to the Pemba channel site in both dry and rainy seasons (Figure 13), and this was found to be statistically significant (F3, 116=16.96, p = 3.36×10-9). This difference in Chl-a concentration between sites and among seasons was further analysed using Bonferroni means comparison test. It was observed that 
Chl-a concentration between different seasons and among different sites was statistically significant, except for between sites in the same season (Table \@ref(tab:tab42))
...
##	Variation of Chlorophyll-a Concentration Between Transects
Comparison of the concentration of in situ Chl-a between transects revealed considerable variation between different transects. At the Pemba channel site, the values of Chl-a during the rainy season were relatively higher at transect 2 compared to transects 1 and 3. The average Chl-a concentration for transect 2 was generally above 0.5 mg/m3, while the average Chl-a concentration for transects 1 and 3 was generally  below 0.26 mg/m3 (Figure 14).  During the dry season, the concentration of Chl-a was relatively very low at all the three transects (Figure 14).

At the Zanzibar channel site during the rainy season, the concentration of Chl-a was relatively higher for transect 3, with a mean concentration of above 0.48 mg/m3 compared to transects 1 and 2 that were observed to have mean concentration below 0.36 mg/m3 (Figure 14). Similar to the Pemba channel site, the concentration of Chl-a at the Zanzibar site during the dry season, was relatively very low for all the three transects (Figure 14).
